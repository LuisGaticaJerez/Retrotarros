# Arco Nintendo GameCube — Tablero de control
...
## Datos clave de la colección de Retrotarros

| Stat | Valor |
|------|-------|
| Juegos | 25 |
| Destacados EN LA COLECCION | Super Mario Sunshine [Player's Choice], Super Smash Bros. Melee (ambos en el Top Mundial), SoulCalibur II, Pokémon XD - Gale of Darkness, WarioWare Inc., Shadow the Hedgehog |
| Resto del catálogo | Mayormente licencias de película/comic (Batman Begins, Catwoman, Spider-Man 2, X2: Wolverine's Revenge, LEGO Star Wars, Crónicas de Narnia, Los Increíbles, El Señor de los Anillos) y deportes/arcade (FIFA 2002, Beach Spikers, R: Racing Evolution, Rayman Arena) |
| Hardware | Ninguno registrado aparte de 1 Wavebird Wireless Controller |
| Nota | Catálogo parejo pero sin joyas de precio muy altas a simple vista -Pokémon XD es el único con "New" (sellado) sobre los USD 700 en el export GameEye, candidato a revisar en el Top Precios |
...
25 juegos es un catálogo intermedio -más grande que PS1 (11) pero más chico que N64 (58) o PS Vita (91). A diferencia de PS1, el catálogo tiene bastante licencia de película/comic (Batman Begins, Catwoman, X2, LEGO Star Wars, Narnia, Los Increíbles, LOTR) mezclada con first-party fuerte. **A evaluar con Luis:** ¿alcanza para un episodio sólido, o se arma un ángulo curado (solo first-party + joyas) en vez de barrer las 25?

### 4. Episodio "no-Latam" — ¿qué ángulo?

GameCube SÍ tuvo distribución oficial en Latam (más débil que PS2 pero presente). El ángulo clásico "la consola nunca llegó" no aplica directo. **Alternativa a evaluar:** juegos que se demoraron en llegar a la región, o el fenómeno de piratería/modchips que afectó fuerte a GameCube en la época (similar al ángulo propuesto para PS1).

### 5. Episodio biográfico — ¿quién?
...
## Conexiones cruzadas con otros arcos

- **Patrón "consola que fundó un género"** — ya usado con N64 (3D), PS Vita (portátil abandonada) y PS1 (survival horror/sigilo/metroidvania); GameCube lo repite con Resident Evil 4 (cámara al hombro que redefinió la acción en tercera persona) y Pikmin (nueva IP de Miyamoto).
- **Conectividad GBA-GameCube** — dato técnico recurrente en el Top Mundial (Animal Crossing, Wind Waker, Metroid Prime, F-Zero GX) que ningún arco anterior tuvo -ángulo propio de esta consola, vale la pena explotarlo en shorts derivados.
- **Colaboración Nintendo-Sega (F-Zero GX)** — dato curioso único de esta generación, buen gancho de short independiente.
...
*Tablero del arco · creado 2026-09-22 · última actualización: 2026-09-22*
