# Descripción YouTube — Top 10 PS1 Precios
...
1. **Top 10 PS1 Más Caros: ninguno es Final Fantasy ni Metal Gear** — 62 chars. (Recomendado)
2. **Un juego de PS1 se vendió por 55 mil dólares (y no es el que crees)** — 65 chars.
...
#PlayStation #PS1 #Retrogaming #Videojuegos #Coleccionismo
```
...
Masivos: `#PlayStation #PS1 #Retrogaming #Videojuegos #Gaming #Retro`
Nicho: `#Coleccionismo #Tekken #TronBonne #JRPG`
...
```
¿Sabían de The Misadventures of Tron Bonne antes de este video? ¿Tienen algún disco de esta lista guardado? Cuéntanos en los comentarios.
```

## Notas de producción

- **Miniatura sugerida:** box art de Tron Bonne + Tekken Long Box + texto "$55.000" + TarroBot.
- Fuente de datos: `docs/pautas/pauta-ps1-top-precios.md`.
