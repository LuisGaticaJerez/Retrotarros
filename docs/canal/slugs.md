...
```
docs/pautas/pauta-n64-top-mundial.md          ← pauta operativa (Claude)
docs/discusiones/discusion-n64-top-mundial.md      ← reunión previa (Luis + Koko)
...
ls docs/pautas/pauta-*.md | foreach { $_.Name -replace 'pauta-(.+)\.md','$1' }
