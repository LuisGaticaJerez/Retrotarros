...
| 01 | `01-docs/canal/identidad-visual.md` | Paleta, tipografias, marca, look and feel |
| 02 | `02-convenciones-docs/canal/proyecto.md` | Slugs, naming, git workflow, Drive sync, idioma chileno neutro |
...
| 05 | `05-docs/pautas/pauta-snes-coleccion.md` | La pauta especifica del episodio actual |
| 06 | `06-docs/discusiones/discusion-snes-coleccion.md` | Decisiones editoriales detras de la pauta SNES |
...
- Pauta MD: `docs/pautas/pauta-snes-coleccion.md`
...
Si esta editando una pauta del episodio actual: tipicamente sera el `studio/<slug>.html` o el `docs/pautas/pauta-<slug>.md`. Si la duda persiste, preguntarle a Luis antes de tocar nada.
...
Seguir el modelo de `05-docs/pautas/pauta-snes-coleccion.md` y los componentes HTML de `04-componentes-html.md`. Avisar a Luis al terminar que tiene que sincronizar al repo principal.
